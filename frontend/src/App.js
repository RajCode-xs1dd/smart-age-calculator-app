...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-teal-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 transition-colors duration-300">
      ...
      {/* Footer */}
      <footer className="border-t border-emerald-100 dark:border-gray-700 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm mt-16">
        <div className="container mx-auto px-4 py-8 text-center text-gray-600 dark:text-gray-400">
          <p>© 2025 Smart Age Calculator. Made with precision and care.</p>
        </div>
      </footer>
    </div>
  );
